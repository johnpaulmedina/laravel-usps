...
class InternationalServiceStandards extends USPSBase
{
     ...
     *
     * @throws \Johnpaulmedina\Usps\Exceptions\ValidationException if country code is invalid
     */
    public function getServiceStandard(string $countryCode, string $mailClass): array
    {
        ...
        if ($code === null) {
            throw new \Johnpaulmedina\Usps\Exceptions\ValidationException("Invalid country code: {$countryCode}.");
        }
